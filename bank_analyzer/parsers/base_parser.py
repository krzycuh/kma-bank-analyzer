    ...
    def _detect_encoding(self, file_path: Path) -> str:
        ...
        try:
            ...
            with open(file_path, 'rb') as f:
                ...
                # chardet often misdetects Polish windows-1250 files as
                # Western encodings (windows-1252 / iso-8859-1), which turns
                # "Tytuł" into "Tytu³". Polish bank exports are either UTF-8
                # or windows-1250, so map all single-byte Western/Central
                # European guesses to windows-1250.
                if encoding:
